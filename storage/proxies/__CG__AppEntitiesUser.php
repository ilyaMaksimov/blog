...
class User extends \App\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'email', 'name', 'is_admin', 'avatar', 'password', 'rememberToken', 'createdAt', 'updatedAt'];
        }
    ...
    public function getPathAvatar()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPathAvatar', []);

        return parent::getPathAvatar();
    }
